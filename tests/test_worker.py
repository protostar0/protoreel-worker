        ...
        "scenes": [
            {
                ...
                "promp_image": "A photo-realistic image of President holding a press conference with the flags of the United States and Japan in the background, emphasizing a momentous announcement.",
    ...
    "request_dict": {
        ...
        "scenes": [
            ...
            },
            {
                ...
                "promp_image": "A photo-realistic image of a bustling New York City skyline with symbolic dollar signs and yen symbols overlayed, representing financial investment.",
                "image_provider": "gemini",
                "subtitle": True
            },
            {
                ...
                "promp_image": "A photo-realistic image of shipping containers at a busy port with agricultural products and cars visible, representing international trade and tariffs.",
                "image_provider": "gemini",
                "subtitle": True
            },
            {
                ...
                "promp_image": "A photo-realistic image of a group of analysts in an office with a world map and international news screens visible, symbolizing ongoing discussions and evaluations.",
                "image_provider": "gemini",
                "subtitle": True
            }
        ]
