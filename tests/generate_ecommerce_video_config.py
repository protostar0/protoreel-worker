...
1. Hook – Capture attention emotionally

2. Product Intro – Showcase what it is

3. Feature Highlight – Show use in action

4. Benefit – Emotional or lifestyle payoff

5. Social Proof – Reinforce trust

6. CTA – Inspire final conversion
...
- Visually include a price discount moment:

  - Show an old price crossed out and a new discounted price clearly visible.

  - Add visual CTA elements (e.g., a hand reaching to tap "Shop Now," glowing light, or urgency cues).

  - Focus composition on excitement, urgency, and conversion.
    ...
    if images:
        ...
        user_message_content.append({
            ...
            "text": "\n\nAnalyze the product images visually and use the insights to:\n"
                   ...
                   "- Create video prompts that showcase the product authentically\n"
    ...
    try:
        ...
        for idx, scene in enumerate(video_config['scenes']):
            ...
            if 'narration_text' not in scene:
                logger.warning(f"Scene {idx + 1} missing narration_text, using placeholder")
                scene['narration_text'] = "Product showcase scene"
            ...
            # Ensure prompt_video exists (from video_prompt if provided)
